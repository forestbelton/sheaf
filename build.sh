...
i686-elf-gcc -Iinclude -Imini-printf -c src/malloc.c -o build/malloc.o \
    -std=gnu99 -ffreestanding -O2 -Wall -Wextra -DLACKS_SYS_TYPES_H \
...
i686-elf-gcc -T linker.ld -o build/sheaf.bin -ffreestanding -O2 -nostdlib \
    ...
    build/malloc.o build/kernel.o -lgcc
